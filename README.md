...
Go to where you save your Processing projects and `git clone <GIT URL WHEN YOU CLICK CODE>`  
```
...
## 2. How to go to the git repository and push new changes... 
...
``` 
- or just save your processing folder to where you git clone'd a repository. 

2. Use `git add <whatever you want to add>` to add whatever files to github. 
```
...
3. Use `git commit -m "YOUR MESSAGE HERE"` command 
```
